...
define("scripts/hit.js", function(exports){
	var waste = require("scripts/factory/waste");
	var UsrScr = require("scripts/lib/UsrScr");
...
define("scripts/game_save_world.js", function(exports){
	/**
	...
	var game_save_worldOver = require("scripts/object/game_save_world-over");
	var knife = require("scripts/object/knife");
	...
	message.addEventListener("waste.fallOutOfViewer", function( waste ){
	    if( state( "game_save_world-state" ).isnot( "playing" ) )
	        return ;
...
define("scripts/main.js", function(exports){
	...
	var sense = require("scripts/sense");
	var UsrScr = require("scripts/lib/UsrScr");
	...
	var game_save_world = require("scripts/game_save_world");
	
	var hit = require("scripts/hit");
...
define("scripts/sense.js", function(exports){
	var UsrScr = require("scripts/lib/UsrScr");
//	var sound = require("scripts/lib/sound");
	var waste = require("scripts/factory/waste");
	...
	var startRecycling = require("scripts/object/startRecycling");
	var newgame_save_world = require("scripts/object/new-game_save_world");
	...
	var UnderConstruction = require("scripts/object/UnderConstruction");
	var game_save_worldOver = require("scripts/object/game_save_world-over");
...
define("scripts/factory/waste.js", function(exports){
	var layer = require("scripts/layer");
	var UsrScr = require("scripts/lib/UsrScr");
	var timeline = require("scripts/timeline");
	var tween = require("scripts/lib/tween");
	...
	var flash = require("scripts/object/flash");
	var garbage = require("scripts/factory/garbage");
...
define("scripts/factory/garbage.js", function(exports){
	var UsrScr = require("scripts/lib/UsrScr");
	var layer = require("scripts/layer").getLayer("garbage");
	var timeline = require("scripts/timeline");
	var tween = require("scripts/lib/tween");
	var tools = require("scripts/tools");
	...
	if( UsrScr.isIe || UsrScr.isSafari )
		num = 7;
...
define("scripts/factory/rotate.js", function(exports){
	...
	exports.create = function( imageSrc, x, y, w, h, z, anim, animDur ){
		var module = {}, image;
		var rotateDire = [12, -12][UsrScr.randomNumber(2)];
		var defaultAngle = UsrScr.randomNumber(360);
...
define("scripts/lib/UsrScr.js", function(exports){
	...
	String.prototype.format = function(conf){
		var rtn = this, blank = {};
		UsrScr.each(conf, function(item, key){
	...
	// if(!Array.prototype.some)
		...
		Array.prototype.random = function(){
			...
			while( i -- )
				ret.push( arr.splice( UsrScr.randomNumber( i + 1 ), 1 )[0] );
			return ret;
		};
	...
	UsrScr = {
		...
		apply: function(form, to, except){
			if(!to)to = {};
			if(except){
				UsrScr.each(form, function(item, key){
					if(key in except)
						return ;
					to[key] = item;
				});
		...
		Class: function(initialize, methods, befores, afters){
			...
			blank = {};
			fn = function(){
				this.instanceId = UsrScr.id();
				initialize.apply(this, arguments);
			};
			prototype = fn.prototype;
			UsrScr.registerClassEvent.call(prototype);
			UsrScr.each(methods, function(item, key){
		...
		registerClassEvent: function(){
			this.on = function(name, fn){
				...
				UsrScr.dispatch(instanceId + name, fn.bind(this));
			};
			this.onbefore = function(name, fn){
				var instanceId = this.instanceId;
				UsrScr.dispatch(instanceId + "before" + name, fn.bind(this));
			};
			...
			this.fireEvent = function(name, args){
				var instanceId = this.instanceId;
				UsrScr.dispatch(instanceId + name, args);
			};
		},
		...
		dispatch: function(){
			...
			send = function( processId, args, scope ){
				...
				if( processItems = map[processId] )
					UsrScr.each(processItems, function(item){
		...
		Element: function(el, returnDom){
			...
			if(typeof handleId == "string"){
				return UsrScr.handle(handleId - 0);
			}else{
				rtn = new UsrScr.BasicElement(el);
				handleId = UsrScr.handle(rtn);
		...
		loadImage: function(urls, onLoadComplete){
			...
			UsrScr.each(urls, function(url){
				...
				UsrScr.tempDom.appendChild(img);
				img.src = url;
			});
		},
		...
		loadScript: function(src, callback){
			UsrScr.request(src, function(text){
				eval(text);
		...
		randomWord: function(){
			...
			return function(length, sourceString){
				...
				UsrScr.each(length, function(index){
	...
	// UsrScr.BasicDrag
	UsrScr.BasicDrag = UsrScr.Class(
		/* constructor */ function(conf){
			conf = UsrScr.fixConfig(conf);
			this.type = UsrScr.fixString(conf.type, "normal");
		...
		/* methods */ {
			bind: function(el, handle){
				el = UsrScr.Element(el);
				handle = UsrScr.Element(handle) || el;
			...
			registerDocumentEvent: function(){
				...
				draging.documentSelectStart =
					UsrScr.addEvent(document, "selectstart", function(e){
						e = e || event;
						e.stopPropagation && e.stopPropagation();
						e.cancelBubble = true;
						return e.returnValue = false;
				...
				draging.documentMouseMove =
					UsrScr.addEvent(document, this.TOUCH_MOVE, function(e){
						var ie, nie;
						e = e || event;
						ie = UsrScr.isIe && e.button != 1;
						nie = !UsrScr.isIe && e.button != 0;
				...
				draging.documentMouseUp =
					UsrScr.addEvent(document, this.TOUCH_END, function(){
						this.endDrag();
					}.bind(this));
			...
			unRegisterDocumentEvent: function(){
				...
				UsrScr.delEvent(document, this.TOUCH_MOVE, draging.documentMouseMove);
				UsrScr.delEvent(document, this.TOUCH_END, draging.documentMouseUp);
				UsrScr.delEvent(document, "selectstart", draging.documentSelectStart);
				clearInterval(draging.timer);
			},
	...
	// UsrScr.BasicElement
	UsrScr.BasicElement = UsrScr.Class(
		...
		/* methods */ {
			...
			style: function(/* unknown1, unknown2 */){
				...
				return function(unknown1, unknown2){
					if(typeof unknown1 == "object"){
						UsrScr.each(unknown1, function(value, key){
							this[key] = value;
						}.bind(this.dom.style));
			...
			remove: function(dom){
				...
				if(dom){
					...
					el = UsrScr.Element(this.dom.parentNode);
					el.remove(this);
				}
				return this;
			},
			...
			addEvents: function(conf){
				...
				el = this.dom;
				UsrScr.each(conf, function(item, key){
					rtn[key] = UsrScr.addEvent(el, key, item);
				});
				return rtn;
			},
			...
			getPos: function(){
				...
				if(el.getBoundingClientRect){
					...
					if(UsrScr.isSafari && this.style("position") == "absolute"){ // safari doubles in some cases
			...
			usePNGbackground: function(image){
				var dom;
				dom = this.dom;
				if(/\.png$/i.test(image) && UsrScr.isIe6){
					dom.style.filter =
			...
			fadeIn: function(callback){
				...
				this.display(true);
				clearInterval(this.fadingInterval);
				this.fadingInterval = setInterval(fading, UsrScr.isIe ? 20 : 30);
			...
			useMouseAction: function(className, actions){
				if(!this.MouseAction)
					this.MouseAction = new UsrScr.MouseAction({ element: this });
...
define("scripts/object/UnderConstruction.js", function(exports){
	var layer = require("scripts/layer");
	var tween = require("scripts/lib/tween");
	var timeline = require("scripts/timeline");
	var message = require("scripts/message");
	...
	exports.set = function(){
		this.image = layer.createImage( "default", "images/UnderConstruction.png", 103, 218, 429, 53 ).hide().scale( 1e-5, 1e-5 );
	};
...
define("scripts/object/startRecycling.js", function(exports){
	var rotate = require("scripts/factory/rotate");
	var tween = require("scripts/lib/tween");
	
	exports = rotate.create("images/startRecycling.png", 41, 240, 175, 175, 1e-5, tween.exponential.co, 500);;
...
define("scripts/object/flame.js", function(exports){
	...
	var layer = require("scripts/layer").getLayer( "waste" );
	var timeline = require("scripts/timeline");
	var UsrScr = require("scripts/lib/UsrScr");
...
define("scripts/object/game_save_world-over.js", function(exports){
	var layer = require("scripts/layer");
	var tween = require("scripts/lib/tween");
	var timeline = require("scripts/timeline");
	var message = require("scripts/message");
	...
	exports.set = function(){
		this.image = layer.createImage( "default", "images/game_save_world-over.png", 75, 198, 490, 85 ).hide().scale( 1e-5, 1e-5 );
	};
...
define("scripts/object/light.js", function(exports){
	...
	exports.overWhiteLight = function(){
	    ...
	    var control = {
	    	...
	    	onTimeEnd: function(){
	    	    mask.remove();
	    	    message.postMessage( "game_save_world.over" );
	    	}
	    };
...
define("scripts/object/new-game_save_world.js", function(exports){
	var rotate = require("scripts/factory/rotate");
	var tween = require("scripts/lib/tween");
	
	exports = rotate.create("images/new-game_save_world.png", 244, 231, 195, 195, 1e-5, tween.exponential.co, 500);;
...
define("scripts/object/ninja.js", function(exports){
	...
	exports = displacement.create("images/save_world.png", 244, 81, 315, -140, 315, 43, {
